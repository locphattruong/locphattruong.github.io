...
I am pursuing the [Master in Computer Vision](https://mcv.uab.cat/) program (2024–2025) at UAB, UOC, UPC, UPF, and UB in Barcelona, Spain. My current research for the Msc Thesis (Apr – Sep 2025) focuses on the reverse problem of Virtual Try-On: generating original clean garment images from try-on outputs. I am co-supervised by [Prof. Sergio Escalara](https://sergioescalera.com/#intro) and [Dr. Meysam Madadi](https://scholar.google.com/citations?user=hWMXdg4AAAAJ&hl=en), as part of [the Human Pose Recovery and Behavior Analysis group](https://www.cvc.uab.es/research-lines/hupba/).
