...
I am a PhD student at [the Human Pose Recovery and Behavior Analysis group](https://www.cvc.uab.es/research-lines/hupba/) (HuPBA), University of Barcelona, Computer Vision Center, co-supervised by [Prof. Sergio Escalera](https://sergioescalera.com/#intro) and [Dr. Meysam Madadi](https://scholar.google.com/citations?user=hWMXdg4AAAAJ&hl=en). My research focuses on visual generative modeling, representation learning, human understanding, and multimodal learning, with an emphasis on Virtual Try-On, garment reconstruction, and clothed human dynamics.

Currently, I am developing commercial Virtual Try-On solutions at Vitonify, HuPBA spin-off startup, and collaborating with [Google](https://research.google/) on clothed human dynamics forecasting as part of my PhD research.

I received an [MSc in Computer Vision](https://mcv.uab.cat/) in 2025 from the Barcelona joint program (UAB, UOC, UPC, UPF, and UB) with a thesis focusing on Virtual Try-Off and diffusion models. Prior to that, I obtained a BE in Mechatronics from [HCMUTE](https://fme.hcmute.edu.vn/ArticleId/bffdb6e0-12cc-4263-921f-c1e0f72cdfb5/introduction-to-mechatronics-department), Ho Chi Minh City, Vietnam, in 2020.

During my master’s studies, I secured a research fellowship at the Computer Vision Center, working with [Prof. Daniel Ponsa](https://orcid.org/0000-0002-7330-6524) on hyperspectral image super-resolution. Before returning to academia, I was a Senior Data Scientist at [Knorex R&D Labs](https://www.knorex.com/research-and-development) working on programmatic advertising and predictive models. Earlier, I was a founding AI engineer at the US startup SceneSeer, contributing to a criminal scene prediction platform and a related US patent application.