...
Previously, I held a research fellowship at the Computer Vision Center, where I worked with [Prof. Daniel Ponsa](https://orcid.org/0000-0002-7330-6524) on hyperspectral image super-resolution using Transformer-based models. Before returning to academia, I was a Senior Data Scientist at [Knorex R&D Labs](https://www.knorex.com/research-and-development), working on programmatic advertising, user response forecasting, and ad ranking systems. Earlier, I was a founding AI engineer at a US startup (SceneSeer), where we explored a cloud-based criminal scene prediction platform and pursued a US patent application.
